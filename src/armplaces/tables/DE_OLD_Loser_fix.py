"""Исправленная копия переходов проигравших DE_OLD (N=2–32).

Строка i — бой i+1, столбец N−2 — категория из N участников; адрес 0 — остановка.
Исправлены N=13,16,28. Оригинал data/DE_OLD_Loser.py не изменяется.
Адреса за пределами боёв могут хранить выбывших. Подробности — в README.md.
"""
