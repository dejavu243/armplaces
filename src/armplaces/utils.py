"""Вспомогательные операции над именами, цепочками и данными турнира.

Поддерживаются добавление без цикла, удаление дубликатов, выбор длин L/L−1
и контейнер TournamentData. Короткие цепочки по умолчанию сохраняются.
Основной граф строится без явного перебора путей; эти функции полезны для анализа.
Описание связанных алгоритмов — в README.md.
"""
